...
export function SubmissionProvider({ children }: { children: React.ReactNode }) {
  ...
  const methods = useForm<DraftInput>({
    ...
    defaultValues: {
      ...
      scholar_retention: { baseline_scholars: 0, last_week: 0, this_week: 0, retention_rate: 0, insight: '' },
      mentor_retention: { last_week: 0, this_week: 0, retention_rate: 0, insight: '' },
      passbook_conversations: { mentors_started: 0, scholars_reached: 0, pct_scholars_reached: 0, avg_scholars_per_mentor: 0, insight: '' },
